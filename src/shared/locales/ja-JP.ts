...
export const jaJP: LocaleMessages = {
  ...
  options: {
    ...
    readSkillFilesVisible: "補助ファイルの読み取りを許可",
    readSkillFilesVisibleHint:
      "有効にすると、AgentはreadSkillFileでreferences/assets/scriptsを読めます。",
    triggerTestPlaceholder: "このSkill説明に対してプロンプトをテスト...",
    triggerTestLikely: "発火しそうです",
    triggerTestWeak: "発火一致が弱いです",
    skillCheckEntry: "SKILL.mdが存在します",
    skillCheckName: "frontmatterのnameがkebab-caseです",
    skillCheckDescription: "descriptionがあります",
    skillCheckReadFiles: "補助ファイルがある場合に読み取り可能です",
    skillCheckReferences: "補助ファイルがSKILL.mdで参照されています",
