...
export const zhTW: LocaleMessages = {
  ...
  options: {
    ...
    readSkillFilesVisible: "允許讀取支援檔案",
    readSkillFilesVisibleHint:
      "開啟後，Agent 可用 readSkillFile 讀取此套件中的 references/assets/scripts。",
    triggerTestPlaceholder: "用一則提示測試這個 Skill 描述...",
    triggerTestLikely: "可能會觸發",
    triggerTestWeak: "觸發匹配較弱",
    skillCheckEntry: "存在 SKILL.md",
    skillCheckName: "frontmatter name 為 kebab-case",
    skillCheckDescription: "已填寫 description",
    skillCheckReadFiles: "有支援檔案時允許讀取",
    skillCheckReferences: "支援檔案已在 SKILL.md 中引用",
    deleteSkill: "刪除Skill",
