...
export const zhTW: LocaleMessages = {
  ...
  sidepanel: {
    ...
    createQuickAction: "建立快捷操作",
    generatingQuickAction: "正在建立快捷操作",
    quickActionCreated: "快捷操作已建立",
    aiWorking: "AI 正在工作",
  ...
  options: {
    ...
    quickActionsDescription: "使用快捷操作，一鍵向 AI 傳送指令。",
    newQuickAction: "新增快捷操作",
    noQuickActionsTitle: "尚無快捷操作",
    noQuickActionsDescription: "建立第一個快捷操作，用一次點擊自動化重複任務。",
    untitledAction: "未命名操作",
    title: "標題",
    instruction: "指令",
    deleteQuickAction: "刪除快捷操作",
    deleteQuickActionConfirm: "刪除此快捷操作？",
    ...
    syncQuickActionsDescription: "透過瀏覽器帳號同步快捷操作範本。",
    syncChats: "同步對話",
