...
export const zhTW: LocaleMessages = {
  ...
  sidepanel: {
    ...
    tool: {
      ...
      cdpInput: { running: "傳送 CDP 輸入中", done: "CDP 輸入已傳送" },
      cdpPage: { running: "控制 CDP 頁面中", done: "CDP 頁面已控制" },
      cdpDiagnostics: { running: "讀取 CDP 診斷中", done: "CDP 診斷已讀取" },
      wait: { running: "等待中", done: "已等待" },
      getCurrentTime: { running: "檢查時間中", done: "時間已檢查" },
      getCurrentTab: { running: "取得目前分頁中", done: "目前分頁已取得" },
      captureVisibleTab: { running: "擷取分頁中", done: "分頁已擷取" },
      downloadAllImagesInTab: { running: "下載圖片中", done: "圖片已下載" },
      ...
      manageChatHistory: { running: "讀取聊天記錄中", done: "聊天記錄已讀取" },
      manageMcpServers: {
        running: "管理 MCP 伺服器中",
        done: "MCP 伺服器已管理",
      },
      ...
      mutatePage: { running: "更新頁面中", done: "頁面已更新" },
      downloadTabToMarkdown: {
        running: "下載 Markdown 中",
        done: "Markdown 已下載",
      },
      ...
      cdpEvaluateScript: { running: "執行頁面腳本中", done: "頁面腳本已執行" },
  ...
  options: {
    ...
    debugLoggingTitle: "診斷日誌",
    debugLoggingDescription:
      "啟用用於串流輸出、工具和助理順序診斷的臨時主控台日誌。",
    debugLoggingEnabled: "啟用診斷主控台日誌",
    debugLoggingEnabledDescription:
      "開啟後會向擴充功能主控台寫入 [OBA ...] 偵錯事件，直到手動關閉。",
