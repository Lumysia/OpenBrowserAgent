...
export const deDE: LocaleMessages = {
  ...
  options: {
    ...
    readSkillFilesVisible: "Hilfsdateien lesen erlauben",
    readSkillFilesVisibleHint:
      "Erlaubt dem Agenten readSkillFile für references/assets/scripts.",
    triggerTestPlaceholder: "Prompt gegen diese Skill-Beschreibung testen...",
    triggerTestLikely: "Wahrscheinliche Auslösung",
    triggerTestWeak: "Schwache Übereinstimmung",
    ...
    skillCheckReadFiles: "Hilfsdateien sind lesbar, wenn vorhanden",
    skillCheckReferences: "Hilfsdateien sind in SKILL.md referenziert",
