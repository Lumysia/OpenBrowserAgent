...
export const ptBR: LocaleMessages = {
  ...
  options: {
    ...
    readSkillFilesVisible: "Permitir leitura de arquivos de apoio",
    readSkillFilesVisibleHint:
      "Permite ao agente usar readSkillFile para references/assets/scripts.",
    triggerTestPlaceholder: "Teste um prompt contra esta descrição...",
    triggerTestLikely: "Provável acionamento",
    triggerTestWeak: "Correspondência fraca",
    skillCheckEntry: "SKILL.md existe",
    skillCheckName: "name no frontmatter é kebab-case",
    skillCheckDescription: "description presente",
    skillCheckReadFiles: "arquivos de apoio legíveis quando presentes",
    skillCheckReferences: "arquivos de apoio referenciados no SKILL.md",
