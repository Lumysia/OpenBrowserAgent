...
export const frFR: LocaleMessages = {
  ...
  options: {
    ...
    readSkillFilesVisible: "Autoriser la lecture des fichiers",
    readSkillFilesVisibleHint:
      "Permet à l'agent d'utiliser readSkillFile pour references/assets/scripts.",
    triggerTestPlaceholder: "Tester une invite avec cette description...",
    triggerTestLikely: "Déclenchement probable",
    triggerTestWeak: "Correspondance faible",
    ...
    skillCheckReadFiles: "fichiers de support lisibles si présents",
    skillCheckReferences: "fichiers de support référencés dans SKILL.md",
