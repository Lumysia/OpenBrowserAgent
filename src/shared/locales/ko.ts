...
export const ko: LocaleMessages = {
  ...
  options: {
    ...
    importSkillZipError: "Skill 가져오기 실패",
    ...
    updatedAt: "업데이트",
    skillSize: "Skill 크기",
    totalSkillsSize: "전체 Skills",
    syncQuotaWarning:
      "Skills 동기화가 브라우저 동기화 한도를 초과할 수 있습니다. 큰 Skill은 로컬에 보관하세요.",
    skillLooksGood: "Skill 상태가 좋습니다",
    skillNeedsAttention: "Skill 확인 필요",
    readSkillFilesVisible: "지원 파일 읽기 허용",
    readSkillFilesVisibleHint:
      "켜면 Agent가 readSkillFile로 references/assets/scripts를 읽을 수 있습니다.",
    triggerTestPlaceholder: "이 Skill 설명에 대해 프롬프트 테스트...",
    triggerTestLikely: "트리거 가능성 높음",
    triggerTestWeak: "트리거 일치 약함",
    skillCheckEntry: "SKILL.md 있음",
    skillCheckName: "frontmatter name은 kebab-case",
    skillCheckDescription: "description 있음",
    skillCheckReadFiles: "지원 파일이 있으면 읽기 가능",
    skillCheckReferences: "지원 파일이 SKILL.md에서 참조됨",
