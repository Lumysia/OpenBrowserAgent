export const enUS = {
  ...
  options: {
    ...
    readSkillFilesVisible: "Allow reading supporting files",
    readSkillFilesVisibleHint:
      "When enabled, the agent can use readSkillFile for references/assets/scripts listed in this package.",
    triggerTestPlaceholder: "Test a prompt against this skill description...",
    triggerTestLikely: "Likely trigger",
    triggerTestWeak: "Weak trigger match",
    skillCheckEntry: "SKILL.md exists",
    skillCheckName: "frontmatter name is kebab-case",
    skillCheckDescription: "description is present",
    skillCheckReadFiles: "supporting files are readable when present",
    skillCheckReferences: "supporting files are referenced from SKILL.md",
