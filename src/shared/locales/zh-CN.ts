...
export const zhCN: LocaleMessages = {
  ...
  options: {
    ...
    readSkillFilesVisible: "允许读取支持文件",
    readSkillFilesVisibleHint:
      "开启后，Agent 可以用 readSkillFile 读取此包里的 references/assets/scripts。",
    triggerTestPlaceholder: "用一条提示词测试这个 Skill 描述...",
    triggerTestLikely: "可能会触发",
    triggerTestWeak: "触发匹配较弱",
    skillCheckEntry: "存在 SKILL.md",
    skillCheckName: "frontmatter name 是 kebab-case",
    skillCheckDescription: "已填写 description",
    skillCheckReadFiles: "有支持文件时允许读取",
    skillCheckReferences: "支持文件已在 SKILL.md 中引用",
    ...
    autoSelectSkillsDescription:
      "当你没有手动选择 Skill 时，允许 AI 为消息选择一个匹配的 Skill。",
    maxToolSteps: "最大工具步数",
